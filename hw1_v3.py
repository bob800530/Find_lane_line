...
def extend_lines(extend_img, line_img):
    ...
    for side in range(0,2,1):
        ...
        draw_extend_line(extend_img, line_top[0], line_top[1], line_bot[0], line_bot[1])
...
extend_lines(extend_image, line_image) 
